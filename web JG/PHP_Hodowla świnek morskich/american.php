...
<body>
    ...
    <main>
        ...
        <section class="left-main">
            ...
            <?php 
                $kw2 = "SELECT DISTINCT data_ur, miot, rasa from swinki JOIN rasy ON swinki.rasy_id=rasy.id WHERE rasy.id=6;";
            ...
            <?php 
                $kw3 = "SELECT imie, cena, opis FROM swinki WHERE rasy_id=6;";
